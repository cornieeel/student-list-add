...
📋 TableView Integration: Displays usernames and ages in a clean table format.

🔄 Live Updates: Adding or deleting instantly refreshes the table.
...
🗂️ MVC‑style architecture (Model, Controller, View)
